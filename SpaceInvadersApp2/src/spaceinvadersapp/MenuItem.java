...
/**
 * Classe que inclui todos os itens que pertencem: os labels, os botões e suas propriedades como estilo da fonte, cor da fonte etc.
 *
 * @author mireli
 */
public class MenuItem extends StackPane {
    ...
    public void setOnAction(Runnable action) {
        setOnMouseClicked(e -> {
            FillTransition ft = new FillTransition(Duration.seconds(0.45), selection, Color.YELLOW, color);
